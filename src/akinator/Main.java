...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        StoredComponent storedcomponent = new StoredComponent("hasActor", "Carrie_Fisher", ""); //instanciate a StoredComponent : specified the property and value. The format is "rdfs" if the value have a primitive type.
